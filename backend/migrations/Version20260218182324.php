 ...
 */
final class Version20260218182324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, commentaire VARCHAR(50) NOT NULL, note VARCHAR(50) NOT NULL, statut VARCHAR(50) NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_8F91ABF0FB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE configuration (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE configuration_parametre (configuration_id INT NOT NULL, parametre_id INT NOT NULL, INDEX IDX_26C3BC1A73F32DD8 (configuration_id), INDEX IDX_26C3BC1A6358FF62 (parametre_id), PRIMARY KEY (configuration_id, parametre_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE parametre (id INT AUTO_INCREMENT NOT NULL, propriete VARCHAR(50) NOT NULL, valeur VARCHAR(50) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, telephone VARCHAR(50) NOT NULL, adresse VARCHAR(50) NOT NULL, date_naissance VARCHAR(50) NOT NULL, photo LONGBLOB NOT NULL, pseudo VARCHAR(50) NOT NULL, role_id INT NOT NULL, INDEX IDX_1D1C63B3D60322AC (role_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE utilisateur_voiture (utilisateur_id INT NOT NULL, voiture_id INT NOT NULL, INDEX IDX_93E9769DFB88E14F (utilisateur_id), INDEX IDX_93E9769D181A8BA (voiture_id), PRIMARY KEY (utilisateur_id, voiture_id)) DEFAULT CHARACTER SET utf8mb4');
